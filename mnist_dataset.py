...
def get_mixed_datastream(dataset, indices, batch_size,
    ...
    data_stream_labeled = DataStream.default_stream(
        dataset,
        iteration_scheme=ShuffledScheme(i_labeled, batch_size))

    data_stream_unlabeled = DataStream.default_stream(
        dataset,
        iteration_scheme=ShuffledScheme(i_unlabeled, batch_size))

    ds = CombinedDataStream(
        data_stream_labeled=Flatten(data_stream_labeled),
        data_stream_unlabeled=Flatten(data_stream_unlabeled))
